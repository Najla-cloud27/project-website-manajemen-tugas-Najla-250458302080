                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('loginProses')}}">
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user @error('email')
                                                is-invalid @enderror" placeholder="Masukkan Email" name="email"
                                                value="{{ old('email')}}">
                                        ...
                                        <div class=" form-group">
                                            <input type="password" class="form-control form-control-user @error('password')
                                                is-invalid @enderror" placeholder="Masukkan Password" name="password">
                                    ...
                                    <div class="text-center">
                                        <small>
                                            Kembali Ke Beranda ? <a href="{{ route('welcome')}}">Klik
                                                Disini</a>
                                        </small>
                                    </div>
                                </div>
